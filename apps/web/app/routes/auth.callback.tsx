...
// see: https://supabase.com/docs/guides/auth/social-login/auth-google?queryGroups=framework&framework=remix&queryGroups=environment&environment=server#application-code
